...
export class Buildings {
    ...
    constructor() {
        ...
        Transform.createOrReplace(Buildings.buildingsParent, {
...
export class Building {
    constructor(_model: string) {
        ...
        Transform.createOrReplace(entity, { parent: Buildings.buildingsParent })
        GltfContainer.createOrReplace(entity, { src: _model })
    }
}