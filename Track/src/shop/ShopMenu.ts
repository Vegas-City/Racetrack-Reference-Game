...
export class ShopMenu {
    ...
    constructor(){
        ...
        new ShopButton(Vector3.create(98.9-2.49,2.4,-9),"models/wearables/gloves_btn.glb",getWearableData("gloves")),
        new ShopButton(Vector3.create(98.9-2.49*2,2.4,-9),"models/wearables/jacket_btn.glb",getWearableData("upperBody")),
        new ShopButton(Vector3.create(98.9-2.49*3,2.4,-9),"models/wearables/pants_btn.glb",getWearableData("lowerBody")),
        new ShopButton(Vector3.create(98.9-2.49*4,2.4,-9),"models/wearables/boots_btn.glb",getWearableData("boots"))]
    }
}
